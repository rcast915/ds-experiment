...
def print_table(results):
    header = (
        f"{'x':>12}  {'y':>12}  {'ref':>12}  {'f32':>12}  {'ds':>12}  "
        f"{'abs_f32':>12}  {'abs_ds':>12}  {'rel_f32':>12}  {'rel_ds':>12}"
    )
    print(header)
    print("-" * len(header))
    for r in results:
...
def print_summary_matrix(results, x_values, y_values):
    print("\nDS better than float32?  (Y = better, N = not better, = = tie)")
...
def print_ds_recovery_matrix(results, x_values, y_values):
    print("\nRecovered DS result:")
...
def main():
    ...
    print_ds_recovery_matrix(results, x_values, y_values)
    print_relerr_matrix(results, x_values, y_values, "rel_err_f32", "Relative error: float32")
    print_relerr_matrix(results, x_values, y_values, "rel_err_ds", "Relative error: DS")
